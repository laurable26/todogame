...
export const useGameData = (supabaseUser) => {
  ...
  const [shopItems] = useState([
    ...
    { id: 1, name: 'Pack Démarrage', price: 50, type: 'boost', duration: 'Instantané', image: '🎒', description: '+500 patates + 50 XP', boostType: 'starter_pack', instant: true },
